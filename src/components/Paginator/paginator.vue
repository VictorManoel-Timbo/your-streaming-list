  ...
  <div class="flex items-center py-4 justify-center bg-slate-950 text-white">
    <RouterLink :to="`/${type_media}/${page}`">
      ...
      <Button type="button" @click="passarPagina(false)"
        class="custom-button-paginator ml-1" unstyled>
...
<style scoped>
.custom-button-paginator {
  @apply no-underline scale-125 p-1 leading-none font-extrabold transition duration-300 hover:scale-100 mt-0;
}
</style>
            ...
            <div class="relative flex h-16 items-center justify-between">
                    ...
                    <div class="hidden flex-1 text-center sm:block">
                        <div class="inline-flex space-x-4 sm:mr-6">
                            <RouterLink v-for="item in navigation" :key="item.name" :to="item.href"
                                :class="[item.current ? ' text-gray-100 hover:bg-cyan-700 hover:text-white' : 'focus:bg-cyan-900 text-gray-100 hover:bg-cyan-700 hover:text-white', 'rounded-md px-3 py-2 text-sm text-center font-medium']"
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <RouterLink to="/favorite/1">
                        <button type="button"
                            class="relative rounded-full bg-cyan-800 p-1 text-gray-300 hover:text-white focus:outline-none focus:text-red-500 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">

...
<template>
  ...
  <div class=" h-full bg-blue-950">
    <header class="text-center font-semibold italic text-3xl text-white">Filmes</header>
    <ul>
      <li v-for="genre in filmes" :key="genre.id" class="my-6 text-white text-center">
        {{ genre.title }}
      </li>
    </ul>
